--- 
title: "Tidy Music Information Retrieval (MIR)"
subtitle: "Music genre classification: a case study of genius, spotifyr, and bbcharts"
author: "Josiah Parry"
date: "`r Sys.Date()`"
...
We can ask many questions, but only a few we can quantify (at the moment). As of today, I am unaware of methods for measuring the impact of A&R companies have in defining [what constitutes a country song or a rap song](https://www.billboard.com/articles/business/8506428/lil-nas-x-old-town-road-splits-country-music-industry-opinion-genre-streaming-age). But what I can do is utilize sources of data that are available today. 

In light of my interest in both music and data science I have worked to create tools to help solve some of the more fundamental data access issues that many scientists have faced. Specifically access to song lyrics and Billboard charts in an analysis ready format in through the R packages [`genius`](https://github.com/josiahparry/genius) and [`bbcharts`](https://github.com/josiahparry/bbcharts) respectively. Another useful tool is [`spotifyr`](https://github.com/charlie86/spotifyr/). Spotify has developed a number of features used to quantify the the audio characteristics of a song which can be accessed via the API wrapper, spotifyr. These packages together have streamlined much of the data acquisition process.
