...
In light of my interest in both music and data science I have worked to create tools to help solve some of the more fundamental data access issues that many scientists have faced. These being accessing lyrics of songs and Billboard charts in an analysis ready format in the format of the R packages genius and bbcharts. Much of the burden of acquiring adequate data have been streamlined with these packages and spotifyr.
